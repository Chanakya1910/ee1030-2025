...
Equivalently,
\begin{align}
\vec{A} &= \myvec{1 & 1 \\ -1 & 1}\myvec{a \\ b}, \quad
\vec{B} = \myvec{1 & -1 \\ 1 & 1}\myvec{a \\ b}.
\end{align}
\end{frame}

% Step 2
\begin{frame}{2. Equidistant Condition}
\begin{align}
\norm{\vec{P}-\vec{A}}^2 &= \norm{\vec{P}-\vec{B}}^2 \\
...
Simplifying,
\begin{align}
2(\vec{B}-\vec{A})^\top \vec{P} &= \vec{B}^\top \vec{B} - \vec{A}^\top \vec{A}
\end{align}
\end{frame}

% Step 3
\begin{frame}{3. Simplification}
\begin{align}
\vec{B}-\vec{A} &= \myvec{0 & -2 \\ 2 & 0}\myvec{a \\ b} \\
\vec{B}^\top \vec{B} - \vec{A}^\top \vec{A} &= 0
\end{align}
Thus,
\begin{align}
(\vec{B}-\vec{A})^\top \vec{P} = 0
\end{align}
\end{frame}

% Step 4
\begin{frame}{4. Final Result}
Expanding,
\begin{align}
(\vec{B}-\vec{A})^\top \vec{P}
&= \myvec{-2b & 2a}\myvec{x \\ y} \\
&= -2bx + 2ay = 0 \\
